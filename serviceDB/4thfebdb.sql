...
-- Dumping data for table serviceapartment.members: ~17 rows (approximately)
DELETE FROM `members`;
INSERT INTO `members` (`id`, `firstname`, `lastname`, `username`, `address`, `email`, `phone`, `govt_id`, `country`, `company_name`, `password`, `photo`, `status`, `paid`, `created_at`) VALUES
	...
	(38, 'Ibrahim', 'Mohammed', '', '', 'myadmin@gmail.com', '09138668012', '', '', '', '$2y$10$1GRW7agaFYwIyIADOX3yiuCiEDI/c0ANwAw8z/hGO924B7yxTnAky', NULL, 'ACTIVE', 'NOT PAID', NULL),
	(39, 'Ibrahim', 'Mohammed', 'admin', 'No 2Ajah Ilaje road', 'admin@gmail.com', '09138668012', '', 'Nigeria', 'Deltech', '$2y$10$bC9.qcjUN4m/xpJrvBg9w.6xieYRKpqn9z1/GUuJ92MQ5kE5NNIMu', '1738659119_59baa719224d6c2916b0.jpeg', 'ACTIVE', 'NOT PAID', NULL);
...
-- Dumping data for table serviceapartment.property_features: ~0 rows (approximately)
...
-- Dumping data for table serviceapartment.property_images: ~16 rows (approximately)
...
-- Dumping data for table serviceapartment.users: ~4 rows (approximately)
DELETE FROM `users`;
