                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap">
                                ...
                                <div class="me-7 mb-4">
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                        <img src="<?= base_url() . 'uploads/profile/image/' . $AgentData['photo'] ?>"
                                            alt="<?= isset($AgentData['firstname']) ? ucfirst($AgentData['firstname']) : "No Name" ?>" />
                                        <div
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">
                                                    <?= isset($AgentData['firstname']) ? ucfirst($AgentData['firstname']) : "No Name" ?>
                                                </a>
                            ...
                            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                                ...
                                <div class="card-body p-9">
                                    ...
                                    <div class="row mb-7">
                                        ...
                                        <div class="col-lg-8">
                                            <span
                                                class="fw-bold fs-6 text-gray-800"><?= isset($AgentData['firstname']) ? $AgentData['firstname'] : "" ?>
                                                <?= isset($AgentData['lastname']) ? $AgentData['lastname'] : "" ?></span>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Row-->
                                    ...
                                    <div class="row mb-7">
                                        ...
                                        <div class="col-lg-8">
                                            <span
                                                class="fw-bold fs-6 text-gray-800"><?= isset($AgentData['agent_id']) ? $AgentData['agent_id'] : "" ?></span>
                                        </div>
                                        <!--end::Col-->
                                    </div>
