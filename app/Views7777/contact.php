    ...
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            ...
            <p>
                ...
                Have a question, concern, or need assistance? Our customer 
                support team is just a message or call away! Whether you’re a 
                landlord looking to list your property or a guest needing help with your booking, 
                we’re here to ensure you have the best experience with Service Apartment 
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6" id="con_form">
                <div class="wow fadeInUp" data-wow-delay="0.5s">
                    <!-- <p class="mb-4">The contact form is currently inactive. Get a functional and working contact form with Ajax & PHP in a few minutes. Just copy and paste the files, add a little code and you're done. <a href="https://htmlcodex.com/contact-form">Download Now</a>.</p> -->
                    <p class="mb-4">
                        Send us a message today about whatever question that is bothering you, our customer service is active 100% 
