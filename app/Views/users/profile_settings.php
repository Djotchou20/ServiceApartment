                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            ...
                            <form enctype="multipart/form-data"
                                action="<?= base_url() .  'user/details/update/' . $userData['id']  ?>" id=""
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                                ...
                                                <div class="image-input-wrapper w-125px h-125px"
                                                    style="background-image: url(<?= base_url() . 'uploads/users/image/' . $userData['photo'] ?>)">
                                                </div>
                                                ...
                                                <label
                                                    ...
                                                    <input type="file" name="file" accept=".png, .jpg, .jpeg"
                                                        placeholder="<?= base_url() . 'uploads/users/image/' . $userData['photo'] ?>"
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <select name="country" aria-label="Select a Country" data-control="select2"
                                                ...
                                                <option
                                                    <?php echo isset($userData['country']) && $data['name'] === $userData['country'] ? 'selected' : '' ?>
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="address"
                                                ...
                                                value="<?= isset($userData['address']) ? $userData['address'] : "" ?>" />
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <!-- <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="course"
                                                class="form-control form-control-lg form-control-solid"
                                                placeholder="Course"
                                                value="</?= isset($userData['course']) ? $userData['course'] : "" ?>" />
                                        </div>
                                    ...
                                    <!-- <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="level"
                                                ...
                                                value="</?= isset($userData['level']) ? $userData['level'] : "" ?>" />
                                        </div>
                                    </div> -->
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
