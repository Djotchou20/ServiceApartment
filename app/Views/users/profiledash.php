                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap">
                                ...
                                <div class="me-7 mb-4">
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                        <img src="<?= base_url() . 'uploads/users/image/' . ($userData['photo'] ?? 'default.jpg') ?>"
                                            alt="<?= isset($userData['name']) ? ucfirst($userData['name']) : 'No Name' ?>" />
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">
                                                    <?= isset($userData['name']) ? ucfirst($userData['name']) : "No Name" ?>
                                                </a>
                                                ...
                                                <a
                                                    ...
                                                    class="d-flex align-items-center text-gray-500 text-hover-primary mb-2">
                                                        <i class="ki-duotone ki-geolocation fs-4 me-1">
                                                            <span class="path1"></span>
                                                            <span class="path2"></span>
                                                            <?= isset($userData['address']) ? lcfirst($userData['address']) : "No address" ?>
                                                        </i></a>
                                                    <a
                                                        class="d-flex align-items-center text-gray-500 text-hover-primary mb-2">
                                                        ...
                                                        <?= isset($userData['email']) ? lcfirst($userData['email']) : "No Email" ?>
                                                    </a>
                                            </div>
                            ...
                            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                                ...
                                <div class="card-body p-9">
                                    ...
                                    <div class="row mb-7">
                                        ...
                                        <div class="col-lg-8">
                                            <span
                                                class="fw-bold fs-6 text-gray-800"><?= isset($userData['name']) ? $userData['name'] : "" ?>
                                            </span>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-7">
                                        ...
                                        <div class="col-lg-8 d-flex align-items-center">
                                            <span
                                                class="fw-bold fs-6 text-gray-800 me-2"><?= isset($userData['phone']) ? $userData['phone'] : "" ?></span>
                                    ...
                                    <div class="row mb-7">
                                        ...
                                        <div class="col-lg-8 d-flex align-items-center">
                                            <span
                                                class="fw-bold fs-6 text-gray-800 me-2"><?= isset($userData['email']) ? $userData['email'] : "" ?></span>
                                    ...
                                    <div class="row mb-7">
                                        ...
                                        <div class="col-lg-8 d-flex align-items-center">
                                            <span
                                                class="fw-bold fs-6 text-gray-800 me-2"><?= isset($userData['address']) ? $userData['address'] : "" ?></span>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <!-- <div class="row mb-7">
                                        ...
                                        <div class="col-lg-8">
                                            <a href="#"
                                                class="fw-semibold fs-6 text-gray-800 text-hover-primary"></?= isset($userData['course']) ? $userData['course'] : "" ?></a>
                                        </div>
                                    </div> -->
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="row mb-7">
                                        ...
                                        <div class="col-lg-8">
                                            <span
                                                class="fw-bold fs-6 text-gray-800"><?= isset($userData['country']) ? $userData['country'] : "" ?></span>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->
