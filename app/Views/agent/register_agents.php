        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
                ...
                <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                    ...
                    <div class="py-20">
                        <!--begin::Form-->
                        <form class="form w-100" action="<?= base_url('submit-agents-data') ?>" method="post">
                            <!--begin::Heading-->
                            ...
                            <div class="row fv-row mb-7">
                                <div class="col-xl-12">
                                    <input class="form-control form-control-lg form-control-solid" type="text"
                                        ...
                                        autocomplete="off" data-kt-translate="sign-up-input-name" />
                            ...
                            <div class="fv-row mb-10">
                                <input class="form-control form-control-lg form-control-solid" type="tel"
                                    ...
                                    autocomplete="off" data-kt-translate="sign-up-input-phone-number" />
            ...
            <div class="d-none d-lg-flex flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat"
                style="background-image: url(<?= base_url() ?>assetss/media/auth/3.png)"></div>
            <!--begin::Body-->
        </div>
