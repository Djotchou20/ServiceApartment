                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div
                                                class="badge <?= ($data['status'] == 'available') ? 'badge-success' : 'badge-light-danger' ?>">
                                                <?= ucfirst($data['status']) ?>
                                            </div>
                                        </td>
                                        <td>
                                            <?= $data['bedrooms'] ?? '' ?> / <?= $data['bathrooms'] ?? '' ?> Bathrooms
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="<?= base_url() . 'admin/properties/edit/' . $data['id'] ?>"
                                                        class="menu-link px-3">Edit Details</a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a href="<?= base_url() . 'admin/properties/status/' . $data['id'] ?>"
