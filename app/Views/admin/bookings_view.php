                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <h1
                            ...
                            Properties Booked</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">
                                <a class="text-muted text-hover-primary">Booking</a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                <thead>
                                    <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-100px">APT Title</th>
                                        <th class="min-w-60px">Payment Status</th>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                class="text-gray-800 text-hover-primary mb-1"><?= $data['title'] ?? '' ?></a>
                                        </td>
                                        <td>
                                        <div
                                                class="badge <?= ($data['payment_status'] == 'paid') ? 'badge-success' : 'badge-light-danger' ?>">
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="<?= base_url() . 'admin/confirm-payment/' . $data['id'] ?>"
                                                        class="menu-link px-3">
                                                        <?= ($data['payment_status'] == 'paid') ? 'Mark Pending' : 'Mark Paid' ?>
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
