                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            ...
                            <form enctype="multipart/form-data"
                                action="<?= base_url() .  'admin/service-settings-update/' . $SettingsData['id']  ?>" id=""
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row mb-6">
                                        <!--begin::Label-->
                                        <label class="col-lg-4 col-form-label fw-semibold fs-6">Service Apartment Logo</label>
                                        <!--end::Label-->
                                        <!--begin::Col-->
                                        <div class="col-lg-8">
                                            <!--begin::Image input-->
                                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                                ...
                                                <div class="image-input-wrapper w-125px h-125px"
                                                    style="background-image: url(<?= base_url() . 'uploads/settings/image/' . $SettingsData['photo'] ?>)">
                                                </div>
                                                ...
                                                <label
                                                    ...
                                                    <input type="file" name="file" accept=".png, .jpg, .jpeg"
                                                        placeholder="<?= base_url() . 'uploads/profile/image/' . $SettingsData['photo'] ?>"
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <input type="hidden" name="id"
                                            ...
                                            placeholder="id"
                                            value="<?= isset($SettingsData['id']) ? $SettingsData['id'] : "" ?>" />
                                        <!-- </div> -->
                                        <!--begin::Label-->
                                        <label
                                            class="col-lg-4 col-form-label required fw-semibold fs-6">Company address</label>
                                        <!--end::Label-->
                                        <!--begin::Col-->
                                        <div class="col-lg-8">
                                            <!--begin::Row-->
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 fv-row">
                                                    <input type="text" name="address"
                                                        ...
                                                        placeholder="address"
                                                        value="<?= isset($SettingsData['address']) ? $SettingsData['address'] : "" ?>" />
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Row-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 fv-row">
                                                    <input type="text" name="email"
                                                        class="form-control form-control-lg form-control-solid"
                                                        placeholder="email"
                                                        value="<?= isset($SettingsData['email']) ? $SettingsData['email'] : "" ?>" />
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Row-->
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="company_name"
                                                ...
                                                value="<?= isset($SettingsData['company_name']) ? $SettingsData['company_name'] : "" ?>" />
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <div class="row mb-6">
                                            ...
                                            <select name="country" aria-label="Select a Country" data-control="select2"
                                                ...
                                                <?php if (isset($CountryList) && is_array($CountryList)) : ?>
                                                    <?php foreach ($CountryList as $data) : ?>
                                                        <option
                                                            <?php echo isset($SettingsData['country']) && $data['name'] === $SettingsData['country'] ? 'selected' : '' ?>
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="facebook"
                                                ...
                                                value="<?= isset($SettingsData['facebook']) ? $SettingsData['facebook'] : "" ?>" />
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="instagram"
                                                ...
                                                value="<?= isset($SettingsData['instagram']) ? $SettingsData['instagram'] : "" ?>" />
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <div class="row mb-6">
                                        <!--begin::Label-->
                                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Twitter</label>
                                        <!--end::Label-->
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="twitter"
                                                ...
                                                value="<?= isset($SettingsData['twitter']) ? $SettingsData['twitter'] : "" ?>" />
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="tel" name="phone"
                                                ...
                                                value="<?= isset($SettingsData['phone']) ? $SettingsData['phone'] : "" ?>" />
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->
