                    ...
                    <div class="card mb-5 mb-xl-10">
                        ...
                        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                            ...
                            <div class="card-title m-0">
                                <h3 class="fw-bold m-0">Agent Details</h3>
                            </div>
                            <!--end::Card title-->
                        </div>
                        <!--begin::Card header-->
                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            ...
                            <form enctype="multipart/form-data"
                                action="<?= base_url() ?>submit-agents-data" id=""
                                ...
                                <div class="card-body border-top p-9">
                                            ...
                                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                                ...
                                                <label
                                                    ...
                                                    <input type="file" name="file" accept=".png, .jpg, .jpeg"
                                                        placeholder="<?= base_url() ?>assets/media/svg/avatars/blank.svg"
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Label-->
                                        <label
                                            class="col-lg-4 col-form-label required fw-semibold fs-6">Full Name</label>
                                        <!--end::Label-->
                                        <!--begin::Col-->
                                        <div class="col-lg-8">
                                            <!--begin::Row-->
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <select name="country" aria-label="Select a Country" data-control="select2" required
                                                ...
                                                <?php if (isset($CountryList) && is_array($CountryList)) : ?>
                                                    <?php foreach ($CountryList as $data) : ?>
                                                        <option
                                                            <?php echo isset($AgentData['country']) && $data['name'] === $AgentData['country'] ? 'selected' : '' ?>
                                                            >
