                        ...
                        <div id="kt_account_settings_profile_details" class="collapse show">
                            ...
                            <form action="<?= site_url('properties/store') ?>" method="post"
                                ...
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row mb-6">
                                        <label
                                            class="col-lg-4 col-form-label required fw-semibold fs-6">Agents</label>
                                        <div class="col-lg-8">
                                            <select name="user_id" required
                                                class="form-select form-select-solid form-select-lg fw-semibold">
                                                <option value="">Select Agents</option>
                                                <?php foreach ($agents as $agents): ?>
                                                <option value="<?= $agents['id'] ?>"><?= esc($agents['name']) ?>
                                                </option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" name="locationmap" required
                                                class="form-control form-control-lg form-control-solid">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="number" name="toilets" required
                                                class="form-control form-control-lg form-control-solid">
                                        </div>
                                    </div>
